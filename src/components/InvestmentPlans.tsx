...
const InvestmentPlans = () => (
  <section className="py-24 bg-white text-zinc-900 border-t border-zinc-100">
    <div className="container mx-auto px-4 text-center">
      <h2 className="text-4xl md:text-5xl font-bold text-amber-500 mb-16">Flexible Investment Plans</h2>
        ...
        {plans.map((plan) => (
          <Card key={plan.title} className="bg-white border-zinc-200 shadow-sm hover:shadow-xl transition-all duration-300">
            ...
            <CardFooter className="pb-8 px-8">
              <Button className="w-full bg-amber-500 hover:bg-amber-600 text-white font-bold py-6 rounded-lg text-lg transition-transform hover:scale-105">
                Create Account
              </Button>
            </CardFooter>
          </Card>
